        ...
        parts: [
          {
            ...
            text:
              [
                ...
                "- ALWAYS use standardized citation format: [p.N] for single pages, [p.N-M] for ranges, [p.N, M, O] for multiple pages.",
                "- Examples: [p.3], [p.15-42], [p.3, 7, 15-20, 25]",
                ...
                "- When creating numbered or bulleted lists, ensure ALL points have content - never leave empty points.",
                "- If you can't complete a list naturally, use fewer points rather than incomplete ones.",
